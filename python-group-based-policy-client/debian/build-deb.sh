...
cp debian/control .
cp debian/rules .
for package in "setuptools" "all" "hacking" "babel" "coverage" "fixtures" "heatclient" "httpretty" "mox" "pbr" "oslosphinx" "oslotest" "sphinx" "subunit" "testscenarios" "testtools" "unittest2"; do
    sed -i "s/python-${package}/python3-${package}/g" debian/control
done
sed -i "s/python:Depends/python3:Depends/g" debian/control
sed -i "s/subunit/python3-subunit/g" debian/control
sed -i "s/cliff-tablib/python3-cliff-tablib/g" debian/control
sed -i "s/testrepository/python3-testrepository/g" debian/control
sed -i "s/2.7/3.3/g" debian/control
sed -i "s/Package: python-group-based-policy-client/Package: python3-group-based-policy-client/g" debian/control
